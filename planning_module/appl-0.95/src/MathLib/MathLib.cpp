...
namespace momdp
{
	...
	// result = x * A
	void mult(SparseVector& result, const applSharedPointer<SparseVector> x, const applSharedPointer<SparseMatrix>  A)
	{
		mult(result, *x, *A);
	}
	void mult(SparseVector& result, const applSharedPointer<SparseVector> x, const SparseMatrix& A)
	{
		mult(result, *x, A);
	}
	void mult(SparseVector& result, const SparseVector& x, const applSharedPointer<SparseMatrix>  A)
	{
		mult(result, x, *A);
	}
