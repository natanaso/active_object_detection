...
void BeliefForest::globalRootPrepare(void) 
{
	...
	{ 
		...
		{
			applSharedPointer<BeliefWithState>  thisRootb_s (new BeliefWithState());
...
void BeliefForest::forcedDelete(applSharedPointer<Belief> pointer)
{
	throw runtime_error("not implemented");
}

void BeliefForest::setup(applSharedPointer<MOMDP> problem, Sample* _sampleEngine, vector <BeliefCache *> *_beliefCacheSet)
{
