...
void BeliefCache::localDelete(applSharedPointer<Belief> pointer)
{
...
int BeliefCache::addBeliefRow( applSharedPointer<belief_vector>& bel)
{
...
int BeliefCache::addBeliefRowWithoutCheck( applSharedPointer<belief_vector>& bel)
{
	//cout << "BeliefCache::addBeliefRow";
	//bel.write(cout) << endl;
	lookupTable->addBeliefRowPair(bel, currentRowCount++);
...
bool BeliefCache::hasBelief( applSharedPointer<belief_vector>& bel)
{
	return  lookupTable->getBeliefRowIndex(bel) != -1;
}

int BeliefCache::getBeliefRowIndex( applSharedPointer<belief_vector>& bel)
{
