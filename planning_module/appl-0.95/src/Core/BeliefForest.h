...
namespace momdp 
{
	...
	public:
		...
		virtual void forcedDelete(applSharedPointer<Belief> pointer);

		void setup(applSharedPointer<MOMDP> problem, Sample* _sampleEngine, vector <BeliefCache *> *_beliefCacheSet);
