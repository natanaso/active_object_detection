...
namespace momdp {
	...
	void FullObsUBInitializer::valueIteration_unfac( applSharedPointer<MOMDP> _pomdp, double eps) 
	{
		pomdp = _pomdp;
	...
	void FullObsUBInitializer::QMDPSolution_unfac( applSharedPointer<MOMDP> _pomdp, double eps) 
	{
		pomdp = _pomdp;
	...
	void FullObsUBInitializer::QValueIteration_unfac( applSharedPointer<MOMDP> _pomdp, double eps) 
	{
		pomdp = _pomdp;
		actionAlphas.resize(pomdp->actions->size());
		FOR(a, pomdp->actions->size())
	...
	void FullObsUBInitializer::valueIteration(applSharedPointer<MOMDP> _pomdp, double eps) 
	{
		pomdp = _pomdp;
	...
	void FullObsUBInitializer::QMDPSolution(applSharedPointer<MOMDP> _pomdp, double eps) 
	{
		pomdp = _pomdp;
	...
	void FullObsUBInitializer::QValueIteration(applSharedPointer<MOMDP> _pomdp, double eps) 
	{
		pomdp = _pomdp;
