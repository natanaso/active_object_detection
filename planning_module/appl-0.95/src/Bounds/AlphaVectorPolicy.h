...
namespace momdp
{
	...
	private:
		...
		string policyFile;
	public:
		AlphaVectorPolicy(applSharedPointer<MOMDP> problem);
		...
		int getBestActionLookAhead(applSharedPointer<belief_vector>& b, DenseVector& belX); // SYL07282010 - modify function so that it follows RSS09 paper. Input to function is b_x and b_y.

		int getBestAction(applSharedPointer<belief_vector>& b, DenseVector& belX);  // Input to function is b_x and b_y.
		int getBestAction(vector<belief_vector>& b, DenseVector& belX);  // SYL07282010 - added the counterpart to int getBestAction(applSharedPointer<belief_vector>& b, DenseVector& belX). Input to function is b_x and b_{y|x}.
		...
		int getBestActionLookAhead_alternative(applSharedPointer<belief_vector>& b, DenseVector& belX);  // SYL07282010 replaced with code which follows RSS09 paper. Input to function is b_x and b_y.
