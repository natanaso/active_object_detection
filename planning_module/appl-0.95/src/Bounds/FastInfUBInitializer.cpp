...
namespace momdp {
	...
	FastInfUBInitializer::FastInfUBInitializer( applSharedPointer<MOMDP> problem, BeliefValuePairPoolSet* _bound)
	{
		pomdp = ( applSharedPointer<MOMDP>) problem;
		bound = _bound;
	...
	FastInfUBInitializer::FastInfUBInitializer(applSharedPointer<MOMDP> problem)
	{
		pomdp = ( applSharedPointer<MOMDP>) problem;
