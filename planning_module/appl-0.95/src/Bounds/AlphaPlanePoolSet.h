...
namespace momdp 
{
	...
	public:
		...
		virtual REAL_VALUE getValue(applSharedPointer<BeliefWithState>& belief);
		virtual applSharedPointer<AlphaPlane> backup(BeliefTreeNode * node);
		virtual applSharedPointer<AlphaPlane> getValueAlpha(applSharedPointer<BeliefWithState>& belief);


		applSharedPointer<AlphaPlane> getBestAlphaPlane(BeliefWithState& b);
		applSharedPointer<AlphaPlane> getBestAlphaPlane(BeliefTreeNode& cn);
		applSharedPointer<AlphaPlane> getBestAlphaPlane1(BeliefWithState& beliefandState);
