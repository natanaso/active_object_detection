...
namespace momdp
{
	...
	public:
		...
		void setup(applSharedPointer<MOMDP> _problem, AlphaPlanePool* _alphaPlanePool)
		{
	...
	protected:
		...
		/////////////////////////////////////
		void updateCorners(applSharedPointer<AlphaPlane> plane, std::vector<double, std::allocator<double> >* values, std::vector<applSharedPointer<AlphaPlane>, std::allocator<applSharedPointer<AlphaPlane> > >* indices);
		void updateCerts(applSharedPointer<AlphaPlane> plane, double delta, int timeStamp);
		void updateMax(applSharedPointer<AlphaPlane> plane, double delta, int timeStamp);
		...
		static bool isMax(applSharedPointer<AlphaPlane> alphaPlane);
