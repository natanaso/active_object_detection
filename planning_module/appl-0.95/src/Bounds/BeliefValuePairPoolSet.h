...
namespace momdp 
{
	...
	public:
		...
		applSharedPointer<BeliefValuePair> addPoint(applSharedPointer<BeliefWithState> beliefandState, double val) 
		{
			state_val sval = beliefandState->sval;
			applSharedPointer<belief_vector>  b = beliefandState->bvec;
