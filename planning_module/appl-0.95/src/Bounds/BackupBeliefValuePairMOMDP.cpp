...
applSharedPointer<BeliefValuePair> BackupBeliefValuePairMOMDP::backup(BeliefTreeNode* cn)
{
	int maxUBAction;
	...
	applSharedPointer<BeliefValuePair> result = boundSet->addPoint(cn->s, newUBVal);    
