...
void FactoredPomdp::mapFastIndexesToValues(applSharedPointer<SparseTable> st) {
...
applSharedPointer<SparseTable> FactoredPomdp::reduceUnmatchedCIWithUI(applSharedPointer<SparseTable>  st, ofstream& debugfile, bool printDebugFile) {
...
void FactoredPomdp::convertFastStateTrans() {
    ...
    vector<applSharedPointer<SparseMatrix> > cOst;
    ...
    vector<applSharedPointer<SparseMatrix> > cOstTr;
...
applSharedPointer<SparseTable> FactoredPomdp::preprocessRewardTable() 
{
    ofstream debugfile;
    ...
    vector<applSharedPointer<SparseTable> > rewardTables;
	...
	applSharedPointer<SparseTable> rewardTable = mergeTables(&functionsDepend, BELIEFFUNCTION, debugfile, DEBUGFACTOREDCONVERSIONREWARD); 
    ...
    applSharedPointer<SparseTable> result = mergeSparseTables(rewardTables, REWARDFUNCTION, debugfile, DEBUGFACTOREDCONVERSIONREWARD);
...
void FactoredPomdp::convertFastObsTrans() {
	...
	for(vector<Function>::iterator obsFunc=observFunctionList.begin();obsFunc!=observFunctionList.end();obsFunc++){
	    ...
	    applSharedPointer<SparseTable> obsTable = obsFunc->sparseT;
    ...
    vector<applSharedPointer<SparseMatrix> > cOobs;
    ...
    vector<applSharedPointer<SparseMatrix> > cOobsTr;
...
void FactoredPomdp::convertFastRewardTrans() {
	...
	for(vector<Function>::iterator rewardFunc=rewardFunctionList.begin();rewardFunc!=rewardFunctionList.end();rewardFunc++){
	    ...
	    applSharedPointer<SparseTable> rewardTable = rewardFunc->sparseT;
	    //assemble commom index for this table using current variable values
	    vector<int> commonIndex;
...
applSharedPointer<SparseTable>  FactoredPomdp::mergeSparseTables(vector<applSharedPointer<SparseTable> > stList, int whichFunction, ofstream& debugfile, bool printDebugFile) {
    ...
    applSharedPointer<SparseTable>  resultTable = stList[0];
...
applSharedPointer<SparseTable>  FactoredPomdp::mergeTables(vector<Function>* functionList, int whichFunction, ofstream& debugfile, bool printDebugFile) {
    ...
    //     applSharedPointer<SparseTable>  resultTable =  (*functionList)[0].sparseT;
    applSharedPointer<SparseTable>  resultTable(new SparseTable(*(*functionList)[0].sparseT));
...
void FactoredPomdp::expandFactoredStateTable(applSharedPointer<SparseTable> sf) {
    ...
    applSharedPointer<SparseTable> expandedTable (new SparseTable(cIheader, sf->uIheader, numCIValues, sf->numUIValues));
...
void FactoredPomdp::mapObservationsUIsToValue(applSharedPointer<SparseTable> st) {
...
void FactoredPomdp::mapFactoredCIsToValue(applSharedPointer<SparseTable> st) {
...
void FactoredPomdp::mapFactoredStateUIsToValue(applSharedPointer<SparseTable> st) {
...
void FactoredPomdp::mapFactoredBeliefIndexesToValue(applSharedPointer<SparseTable> st) {
...
void FactoredPomdp::convertFactoredStateReparamTrans() {
	...
	for(vector<Function>::iterator stateFunc=stateFunctionList.begin();stateFunc!=stateFunctionList.end();stateFunc++){
	    ...
	    applSharedPointer<SparseTable> stateTable = stateFunc->sparseT;
	    //assemble commom index for this table using current variable values
	    vector<int> commonIndex;
...
vvSparseMatrix FactoredPomdp::helperPreSparseMatrixToSparseMatrix(vvPreSparseMatrix precm) 
{
    ...
    {
	vector<applSharedPointer<SparseMatrix> > temp;
...
void FactoredPomdp::convertFactoredRewardTrans() {
    ...
    vector<applSharedPointer<SparseMatrix> > cOreward;
...
void FactoredPomdp::convertFactoredTerminalStateReward() 
{
	...
	for(vector<Function>::iterator tRewardFunc=terminalStateRewardFunctionList.begin();tRewardFunc!=terminalStateRewardFunctionList.end();tRewardFunc++){
	    ...
	    applSharedPointer<SparseTable> tRewardTable = tRewardFunc->sparseT;
	    //assemble commom index for this table using current variable values
	    vector<int> commonIndex;
    ...
    applSharedPointer<SparseMatrix>  terminalReward;
...
void FactoredPomdp::preprocessBeliefTables(ofstream& debugfile, bool printDebugFile) 
{
	...
	applSharedPointer<SparseTable> old = processedBeliefFunctionList[i].sparseT;
	...
	newNumCIValues.insert(newNumCIValues.end(), old->numUIValues.begin(), old->numUIValues.end());
		processedBeliefFunctionList[i].sparseT = applSharedPointer<SparseTable> (new SparseTable(newParent, old->uIheader, newNumCIValues, old->numUIValues));
...
void FactoredPomdp::mergeBeliefTables(ofstream& debugfile, bool printDebugFile) {
    ...
    applSharedPointer<SparseTable>  finalBeliefTable2;
...
applSharedPointer<SparseTable> FactoredPomdp::expandObsRewSparseTable(applSharedPointer<SparseTable> st, int whichFunction) {
    ...
    applSharedPointer<SparseTable> newSt (new SparseTable(cIheader, uIheader, numCIValues, numUIValues));
...
applSharedPointer<SparseTable> FactoredPomdp::removeRedundantUIsFromReward(applSharedPointer<SparseTable> st) {
    ...
    applSharedPointer<SparseTable> st2(new SparseTable(st->cIheader, newUIHeader, st->numCIValues, newNumUIValues));
