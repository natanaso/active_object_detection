...
/**********************************************************************/
custom_Matrix newMatrix( int num_rows, int num_non_zero ) {
	custom_Matrix matrix;

	matrix = (custom_Matrix) malloc( sizeof( *matrix ));
...
/**********************************************************************/
void destroyMatrix( custom_Matrix matrix ) {
...
/**********************************************************************/
custom_Matrix transformIMatrix( I_Matrix i_matrix ) {
	/*
...
/**********************************************************************/
REAL_VALUE sumRowValues( custom_Matrix matrix, int row ) {
	REAL_VALUE sum = 0.0;
	int col;
...
/**********************************************************************/
void displayMatrix( custom_Matrix matrix ) {
	int i, j;
...
/**********************************************************************/
REAL_VALUE getEntryMatrix( custom_Matrix matrix, int row, int col ) {
	/*
