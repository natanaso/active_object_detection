...
typedef struct Matrix_Struct *custom_Matrix;
...
extern custom_Matrix newMatrix( int num_rows, int num_non_zero );
extern void destroyMatrix( custom_Matrix matrix );
extern custom_Matrix transformIMatrix( I_Matrix i_matrix );
extern void displayMatrix( custom_Matrix matrix );
extern REAL_VALUE sumRowValues( custom_Matrix matrix, int row );
extern REAL_VALUE getEntryMatrix( custom_Matrix matrix, int row, int col );
