...
extern custom_Matrix *P;  /* Transition Probabilities */
extern custom_Matrix *R;  /* Observation Probabilities */
extern custom_Matrix *QI;  /* The immediate values, for MDPs only */
extern custom_Matrix Q;  /* Immediate values for state action pairs.  These
