...
applSharedPointer<BeliefWithState> BeliefTransitionMOMDP::nextBelief(applSharedPointer<belief_vector>& belY, DenseVector& belX, int a, int o, int obsX)
{
	applSharedPointer<MOMDP> momdpProblem = appl_dynamic_pointer_cast<MOMDP> (problem);
	applSharedPointer<BeliefWithState> result (new BeliefWithState());
...
applSharedPointer<BeliefWithState> BeliefTransitionMOMDP::nextBelief(applSharedPointer<BeliefWithState> bp, int a, int o, int obsX )
{
	SparseVector jspv;
	applSharedPointer<MOMDP> momdpProblem = appl_dynamic_pointer_cast<MOMDP> (problem);
...
applSharedPointer<BeliefWithState> BeliefTransitionMOMDP::nextBelief2(applSharedPointer<BeliefWithState> bp, int a, int o, int obsX, applSharedPointer<SparseVector>& jspv )
{
	applSharedPointer<MOMDP> momdpProblem = appl_dynamic_pointer_cast<MOMDP> (problem);
	//cout << " jspv " << endl;
	//jspv.write(cout) << endl;
