...
namespace momdp
{
	...
	public:
		EvaluationEngine();
		void setup(applSharedPointer<MOMDP> problem, applSharedPointer<AlphaVectorPolicy> policy, BeliefForest* _beliefForest, vector <BeliefCache *> *_beliefCacheSet, Sample *_sampleEngine, SolverParams * solverParams);
		...
		BeliefTreeNode* searchNode(applSharedPointer<BeliefWithState>  belief);
